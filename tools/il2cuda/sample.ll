...
$"??_C@_0BG@LDPNJIPD@Using?5CUDA?5Device?5?$CFs?6?$AA@" = comdat any

$"?_OptionsStorage@?1??__local_stdio_printf_options@@9@4_KA" = comdat any

@"??_C@_0BG@LDPNJIPD@Using?5CUDA?5Device?5?$CFs?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [22 x i8] c"Using CUDA Device %s\0A\00", comdat, align 1
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %8 = call i32 @cuDeviceGet(i32* %6, i32 0)
  %9 = load i32, i32* %6, align 4
  %10 = getelementptr inbounds [128 x i8], [128 x i8]* %7, i64 0, i64 0
  %11 = call i32 @cuDeviceGetName(i8* %10, i32 128, i32 %9)
  %12 = getelementptr inbounds [128 x i8], [128 x i8]* %7, i64 0, i64 0
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @"??_C@_0BG@LDPNJIPD@Using?5CUDA?5Device?5?$CFs?6?$AA@", i64 0, i64 0), i8* %12)
  ret i32 0
}

declare dso_local i32 @cuDeviceGet(i32*, i32) #1

declare dso_local i32 @cuDeviceGetName(i8*, i32, i32) #1
...
define linkonce_odr dso_local i32 @_vfprintf_l(%struct._iobuf* %0, i8* %1, %struct.__crt_locale_pointers* %2, i8* %3) #4 comdat {
  %5 = alloca i8*, align 8
...
attributes #4 = { noinline optnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
